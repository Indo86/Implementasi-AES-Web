...
<figure class="text-center mt-4" style="padding-top: 5rem;">
    ...
    <p class="fw-bold g-2">Layanan Permohonan Desa Konoha</p>
  </blockquote>
...
<div class="container mt-4">
        <nav id="navbar-example2" class="navbar bg-body-tertiary shadow rounded px-3 mb-3">
          <div class="col-12">
          <ul class="nav nav-pills">
            <div class="col-3 text-center">
                ...
                <a class="nav-link active" aria-current="page" href="halamanAdmin.php" style="text-decoration:none;">
        ...
        <li class="nav-item">
              ...
              <a class="nav-link" aria-current="page" href="halamanAdmin2.php" style="text-decoration:none;">
    ...
    <div class="col-3 text-center">
        ...
        <li class="nav-item">
              ...
              <a class="nav-link" aria-current="page" href="halamanAdmin3.php" style="text-decoration:none;">
      ...
      <div class="col-3 text-center">
        ...
        <a class="nav-link" aria-current="page" href="halamanAdmin4.php" style="text-decoration:none;">
                        
          <i class="bi bi-clipboard-x-fill fs-2"></i>
  ...
  <div class="container mt-3 justify-text-center">
        ...
        <?php 
          ...
          if(isset($_POST["cari"])){
            ...
            $query = "SELECT * FROM permohonan WHERE 
            jenis_permohonan LIKE '%$keyword%' OR
            setatus_permohonan LIKE '%$keyword%' OR
            nama LIKE '%$keyword%' AND setatus_permohonan =''";
            

          }else{
            $query = "SELECT * FROM permohonan WHERE setatus_permohonan = ''";
          }
        $i = 1;
        ...
        ?>
          <tr>
            ...
            <td><?= $data['setatus_permohonan']; ?></td>
            <td>
            <a href="responAdmin.php?id=<?=$data['id_permohonan']?>" style="text-decoration:none">
            <button type="button" class="btn btn-outline-success">Respon</button>
            </a>
            </td>
          </tr>
          <?php } ?>
