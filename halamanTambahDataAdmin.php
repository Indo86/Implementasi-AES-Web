...
<div class="card shadow-sm bg-primary">
  ...
  <div class="row">
    ...
    <div class="col-4">
      ...
      <h3 class="text-light text-center">Form Data Pendataan Admin</h3>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
        <select class="form-select" aria-label="Default select example" name="nik">
            ...
            $chiperAlgo= 'AES-128-CBC';
            $options = 0;
            $query = "SELECT * FROM penduduk";  // Menghapus WHERE
            $result = mysqli_query($conn, $query);
            while($datum = mysqli_fetch_assoc($result)){
                // Mendekripsi nilai NIK sebelum ditampilkan
                $nik = openssl_decrypt($datum["nik"], $chiperAlgo, $keyAes, $options, $ivAes);
            ?>
